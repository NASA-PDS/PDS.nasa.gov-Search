...
class SearchBarTargetFacet extends Component {
    componentDidMount() {
    }
    ...
    handleInputChange = (e) => {
        ...
        this.setState({
            ...
            this.props.dispatchSearchBarTargetFacetChange(this.state)
        });
    } 
    ...
    render() {
        ...
        if(this.props.appReducer.searchFacets &&
            ...
            this.props.appReducer.searchFacets.target.results.response &&
            this.props.appReducer.searchFacets.target.results.response.docs){
                docs = this.props.appReducer.searchFacets.target.results.response.docs;
        }
...
const mapDispatchToProps = dispatch => ({
    dispatchSearchBarTargetFacetChange: (input) => dispatch(getSearchBarTargetFacetResults(input))
});
 
export default connect(mapStateToProps, mapDispatchToProps)(SearchBarTargetFacet);